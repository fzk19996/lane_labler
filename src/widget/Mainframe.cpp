...
void Mainframe::open() {
  ...
  if (!retValue.isNull()) {
    ...
    // PyRun_SimpleString("sys.path.append('/home/fzkgod/src/catkin_ws/src/point_labeler/scripts')");
    // PyObject *pModule = PyImport_ImportModule("lane_projection");
    // PyObject *pFunc = PyObject_GetAttrString(pModule, "get_superposition_image");
    // PyObject *pArg = Py_BuildValue("(s, i)", "/home/fzkgod/dataset/dataset/kittivo/sequences/01", 50);
    // PyObject *result = PyEval_CallObject(pFunc, pArg);
    QString filename1("/home/fzkgod/src/catkin_ws/src/point_labeler/fov_lane.png");
    QString filename2("/home/fzkgod/src/catkin_ws/src/point_labeler/fov.png");
    QImage* img1=new QImage;
    QImage* img2=new QImage;
    if(! ( img1->load(filename1) ) || ! (img2->load(filename2)) ) //加载图像
    {
    ...
    ui.label_7->setPixmap(QPixmap::fromImage(*img2));
...
void Mainframe::on_tab_4_destroyed()
{
